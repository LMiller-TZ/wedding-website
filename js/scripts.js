$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Luke and Ali's Wedding",

            // Event start date
            start: new Date('Apr 5, 2024 17:00'),
            ...
            end: new Date('Apr 7, 2024 10:00'),

            // Event Address
            address: 'The Retreat At Balcones Springs, Texas',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Luke Miller or Ali Zinnen at +1 6153429319 or +1 2155185523."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 30.557970, lng: -98.115761};
...
function initBBSRMap() {
    var la_fiesta = {lat: 30.557970, lng: -98.115761};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
